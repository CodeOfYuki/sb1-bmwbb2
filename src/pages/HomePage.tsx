        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            <div className="text-center">
              <div className="mb-4">
                <img src="/images/step1.png" alt="Discover & Sign Up" className="mx-auto" />
              </div>
            ...
            <div className="text-center">
              <div className="mb-4">
                <img src="/images/step2.png" alt="Set Your Goals" className="mx-auto" />
              </div>
            ...
            <div className="text-center">
              <div className="mb-4">
                <img src="/images/step3.png" alt="Launch Your Campaign" className="mx-auto" />
              </div>
            ...
            <div className="text-center">
              <div className="mb-4">
                <img src="/images/step4.png" alt="Track & Improve" className="mx-auto" />
              </div>
            ...
            <div className="text-center">
              <div className="mb-4">
                <img src="/images/step5.png" alt="Celebrate Progress" className="mx-auto" />
              </div>
